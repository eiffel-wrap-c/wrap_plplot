...
feature {NONE} -- Implementation wrapper for struct struct _ldiv_t

	sizeof_external: INTEGER 
		external
			"C inline use <plplot.h>"
		alias
			"sizeof(struct _ldiv_t)"
		end
	...
	set_c_quot (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct _ldiv_t*)$an_item)->quot =  (long)$a_value
			]"
		ensure
	...
	set_c_rem (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct _ldiv_t*)$an_item)->rem =  (long)$a_value
			]"
		ensure
