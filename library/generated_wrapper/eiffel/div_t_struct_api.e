...
feature {NONE} -- Implementation wrapper for struct struct _div_t

	sizeof_external: INTEGER 
		external
			"C inline use <plplot.h>"
		alias
			"sizeof(struct _div_t)"
		end
	...
	set_c_quot (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct _div_t*)$an_item)->quot =  (int)$a_value
			]"
		ensure
	...
	set_c_rem (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct _div_t*)$an_item)->rem =  (int)$a_value
			]"
		ensure
