...
feature {NONE} -- Implementation wrapper for struct PLDisplay
	...
	set_c_x (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((PLDisplay*)$an_item)->x =  (unsigned int)$a_value
			]"
		ensure
	...
	set_c_y (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((PLDisplay*)$an_item)->y =  (unsigned int)$a_value
			]"
		ensure
	...
	set_c_width (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((PLDisplay*)$an_item)->width =  (unsigned int)$a_value
			]"
		ensure
	...
	set_c_height (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((PLDisplay*)$an_item)->height =  (unsigned int)$a_value
			]"
		ensure
